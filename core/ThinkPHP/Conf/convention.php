...
return  array(
    ...
    'LOG_LEVEL'             =>  'EMERG,ALERT,CRIT,ERR',// 允许记录的日志级别'EMERG,ALERT,CRIT,ERR,WARN,NOTIC,INFO,DEBUG,SQL',  // 允许记录的日志级别
    'LOG_FILE_SIZE'         =>  2097152,	// 日志文件大小限制
    'LOG_EXCEPTION_RECORD'  =>  false,    // 是否记录异常信息日志
	
	'LOG_DB_RECORD'			=>  true,   // 开启日志数据库记录
	'LOG_DB_TABLES'			=>  "log",   // 日志记录数据库表名，默认 log 
	'LOG_DB_TAGS'			=>  8,   // 日志记录数据库标记长度 
	'LOG_DB_FIELDS'			=>  "logtags,detail",   // 日志记录数据库字段 0为tags 1为内容
